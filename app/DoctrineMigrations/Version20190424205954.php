 ...
 */
class Version20190424205954 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE telephone (id INT AUTO_INCREMENT NOT NULL, number VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, dateAdd DATETIME NOT NULL, authorId INT DEFAULT NULL, INDEX IDX_450FF010A196F9FD (authorId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
